    ...
    return Scaffold(
      ...
      body: StreamBuilder<GameRoom?>(
        ...
        builder: (context, snapshot) {
          ...
          final isMyTurn =
              me != null && activePlayer?.uid == me.uid && room.isPlaying;
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: room.players.map((player) {
                      final isActive =
                          activePlayer?.uid == player.uid && room.isPlaying;
                          ...
                          children: [
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isWinning = room.winningCells
                                    .any((e) => e[0] == row && e[1] == col);
                ...
                ObsidianCard(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Historial de jugadas',
                          style: TextStyle(
